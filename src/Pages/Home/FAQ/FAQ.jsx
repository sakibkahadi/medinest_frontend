...
<div className="grid md:grid-cols-2 px-2 mb-10">

    <div>
        <img className=" h-full w-full " src="https://i.ibb.co.com/7RfJhRF/1459-Faq-Animations-Free-Downloadin-Lottie-JSONGIFMP4-ezgif-com-animated-gif-maker.gif" alt="" />
    </div>

    <div className="">
        <div className="mb-8 flex justify-start items-center">
            <p className="lg:text-5xl md:text-3xl text-2xl font-bold text-[#050233]  pl-2">Important FAQ</p>
